...
public class ColorPalettesContext(DbContextOptions<ColorPalettesContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Palette>().HasData(
            ...
            {
                Id = 2,
                Colors = new[] { "#ffffff", "#000000", "#ff0000", "#00ff00" },
                Highlighted = false,
            ...
            {
                Id = 3,
                Colors = new[] { "#123456", "#654321", "#abcdef", "#fedcba" },
                Highlighted = true,
            ...
            {
                Id = 4,
                Colors = new[] { "#0f0f0f", "#f0f0f0", "#aabbcc", "#ccbbaa" },
                Highlighted = false,
            ...
            {
                Id = 5,
                Colors = new[] { "#ff5733", "#c70039", "#900c3f", "#581845" },
                Highlighted = true,
            ...
            {
                Id = 6,
                Colors = new[] { "#f4e04d", "#f2a541", "#f08a5d", "#b83b5e" },
                Highlighted = false,
            ...
            {
                Id = 7,
                Colors = new[] { "#6a0572", "#a40a3c", "#ff1e56", "#ffc93c" },
                Highlighted = true,
            ...
            {
                Id = 8,
                Colors = new[] { "#283c63", "#928a97", "#f2f4f3", "#e2dfd2" },
                Highlighted = false,
